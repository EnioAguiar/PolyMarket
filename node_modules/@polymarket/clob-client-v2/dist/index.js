...
var createL1Headers = async (signer, chainId, nonce, timestamp, address) => {
...
import { encodeAbiParameters, hashTypedData as hashTypedData2, keccak256, toHex } from "viem";
...
var ORDER_TYPE_HASH = keccak256(toHex(ORDER_TYPE_STRING));
var DOMAIN_TYPE_HASH = keccak256(
  toHex("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)")
);
var TYPED_DATA_SIGN_STRUCT = [
...
var CTF_EXCHANGE_NAME_HASH = keccak256(toHex(CTF_EXCHANGE_V2_DOMAIN_NAME));
var CTF_EXCHANGE_VERSION_HASH = keccak256(toHex(CTF_EXCHANGE_V2_DOMAIN_VERSION));
var ExchangeOrderBuilderV2 = class {
  ...
  buildOrderHash(orderTypedData) {
    return hashTypedData2(orderTypedData);
  }
};
...
var createMarketOrder = async (eoaSigner, chainId, signatureType, funderAddress, userMarketOrder, options, version) => {
  ...
  const signerForOrder = signatureType === 3 /* POLY_1271 */ ? maker : eoaSignerAddress;
...
var ClobClient = class {
  ...
  constructor({
    ...
    this.signatureType = signatureType ?? 0 /* EOA */;
    this.funderAddress = funderAddress;
    this.tickSizes = {};
    this.negRisk = {};
    this.feeRates = {};
