...
**A EOA `0x18a658c6...` (dinheiro real) nunca foi conectada ao Polymarket** — confirmado: `GET /api/profile/userData?address=0x18a658c6...` retorna `null`, sem conta nenhuma. É uma carteira Polygon "solta", com fundos, mas sem histórico ou conta associada no Polymarket ainda.
